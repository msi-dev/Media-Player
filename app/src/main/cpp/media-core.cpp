...
Java_com_msi_ndk_NativeMediaBridge_detectFormatNative(
        JNIEnv* env,
        jobject thiz,
        jstring file_path) {
    if (!file_path) {
...
Java_com_msi_ndk_NativeMediaBridge_isFormatSupportedNative(
        JNIEnv* env,
        jobject thiz,
        jstring format) {
    if (!format) {
...
JNIEXPORT jstring JNICALL
Java_com_msi_ndk_NativeMediaBridge_getNativeOptimizationProfileNative(
        JNIEnv* env,
        jobject thiz) {
